        ...
        <div className="px-4 min-h-screen flex items-center justify-center p-2">
            <div className="max-w-6xl mx-auto relative">
                ...
                <div className="grid grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
                    ...
                    <p className="text-xs text-slate-600 mt-1.5">Dehradun, Uttarakhand, India</p>
                    </div>
                    <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                    ...
                    <p className="text-xs text-slate-600 mt-1.5">+91 8218388093</p>
                    </div>
                    <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                    ...
                    <p className="text-xs text-slate-600 mt-1.5">shubhamrana181945@gmail.com</p>
                    </div>

                    <a target='_blank' href="https://www.linkedin.com/in/shubham-rana45/">
                        <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                            <svg height={24} width={24} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path className="group-hover:fill-[#171543] duration-300" d="M20,2H4C2.9,2,2,2.9,2,4v16c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V4C22,2.9,21.1,2,20,2z M8.5,19H6V10h2.5V19z M7.3,9 h-0.1C6.4,9,6,8.6,6,8.1V7.9c0-0.5,0.4-0.9,0.9-0.9h0.1C7.6,7,8,7.4,8,7.9v0.1C8,8.6,7.6,9,7.3,9z M19,19h-2.5v-4.9 c0-1.2-0.4-2-1.4-2c-0.8,0-1.3,0.6-1.5,1.2h-0.1V19H10V10h2.3v1.3h0C12.7,10.7,14,9.9,15.5,9.9c2.1,0,3.5,1.4,3.5,3.8V19z"/>
                            </svg>
                            <h4 className="text-slate-900 text-sm font-semibold mt-4">LinkedIn</h4>
                            <p className="text-xs text-slate-600 mt-1.5">Connect us</p>
                        </div>
                    </a>
                ...
                <div className="lg:col-span-2 bg-gray-100 rounded-lg sm:p-10 p-6 z-10 max-lg:-order-1">
                    ...
                    <div className="max-w-md mx-auto space-y-3">
                        ...
                        <button type='button'
                        className="text-white w-full relative bg-indigo-600 hover:bg-[#111] rounded-md text-sm px-6 py-3 cursor-pointer !mt-2">
